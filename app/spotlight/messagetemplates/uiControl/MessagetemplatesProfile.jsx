...
export const MOSY_ACCESS_KEY = "MANAGE_MESSAGE_TEMPLATES";
          ...
          <form onSubmit={postMessagetemplatesFormData} encType="multipart/form-data" id="message_templates_profile_form">
            ...
            <h3 className="col-md-12 title_text text-left p-0 pt-3 hive_profile_title row justify-content-center m-0 ">
              <div className="col m-0 p-0 pb-3">
                {message_templatesNode?.primkey ? (  <span>{`Template / ${message_templatesNode?.template_name}`}</span> ) :(<span> New Template</span>)}
              </div>
      ...
      <div className="row justify-content-center m-0 p-0 col-md-12" id="">
        ...
        <div className="col-md-12 row justify-content-center m-0  p-0">
          ...
          <div className="col-md-12 row p-0 justify-content-center p-0 m-0">
            ...
            <div className="col-md-11 bg-white border border_set shadow-md p-4 mb-4 hive_form_section  ">
              ...
              <div className="row justify-content-start col-md-12 p-0 m-0 ">
                ...
                label="Subject"
                value={message_templatesNode?.message_subject || ""}
                onChange={handleInputChange}
                context={{ hostParent: hostParent  }}
                inputOverrides={{}}
                type="text"
          ...
          <section className="hive_control">
            <input type="hidden" id="message_templates_dataNode" name="message_templates_dataNode" value={paramMessagetemplatesUptoken}/>
