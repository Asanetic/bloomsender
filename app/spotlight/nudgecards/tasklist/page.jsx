...
import PaymentRequestCard from '../paymentcardtemp';
import TaskListCard from '../taskListCardTemp';

export async function generateMetadata() {
  const mosyTitle = "Asanetic Care Card";
...
export default function NudgeCardMainPage() {
