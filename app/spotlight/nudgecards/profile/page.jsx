...
import NudgecardsProfile from '../uiControl/NudgecardsProfile';
...
export default function NudgecardsMainProfilePage() {
          ...
          <div className="page-wrapper">
             <div className="content container-fluid p-0 m-0 ">
               <Suspense fallback={<div className="col-md-12 p-5 text-center h3">Loading...</div>}>
                 <NudgecardsProfile 
                    dataIn={{ parentUseEffectKey: "initNudgecardsProfile" }} 
